...
jumlah_tanggungan1 = st.number_input('Masukkan Jumlah Tanggungan')
jumlah_tanggungan2 = st.number_input('Masukkan Jumlah Tanggungan')
jumlah_tanggungan3 = st.number_input('Masukkan Jumlah Tanggungan')
